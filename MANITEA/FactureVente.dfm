object Form6: TForm6
  ...
  object Table2: TTable
    ...
    Left = 112
    Top = 472
    object Table2Code_C: TStringField
      FieldName = 'Code_C'
      Size = 5
    end
    object Table2Prenom_C: TStringField
      FieldName = 'Prenom_C'
    end
    object Table2Adress_C: TStringField
      FieldName = 'Adress_C'
      Size = 30
    end
    ...
    object Table2RC_C: TStringField
      FieldName = 'RC_C'
      Size = 15
    end
    object Table2Al_C: TStringField
      FieldName = 'Al_C'
      Size = 15
    end
    object Table2IF_C: TStringField
      FieldName = 'IF_C'
      Size = 15
    end
    object Table2Nom_C: TStringField
      FieldName = 'Nom_C'
    end
  end
